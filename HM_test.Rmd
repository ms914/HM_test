...
Hier ist der gesamte Text mit lesbaren Formeln:
...
Summe von n gleich 1 bis unendlich von Bruchstrich 1 durch n 3 hoch n mal Klammer auf x minus 1 Klammer zu hoch n

konvergiert, verwendet man das Konvergenzkriterium für Potenzreihen, insbesondere das Wurzelkriterium oder das Quotientenkriterium. Der Konvergenzradius R dieser Potenzreihe um x gleich 1 gibt an, in welchem Bereich die Reihe konvergiert. Man berechnet den Radius der Konvergenz und stellt fest, dass die Reihe für Betrag von x minus 1 kleiner als R konvergiert.

**Aufgabe 2 (14 Punkte)**

Für die Funktion f von x gleich 1 durch x hoch 2 mal Klammer auf x minus 3 Klammer zu ergibt sich der maximale Definitionsbereich durch das Ausschließen der Punkte, an denen der Nenner null wird, also x ungleich 0 und x ungleich 3.
...
- Verhalten an den Rändern: Man untersucht das Verhalten der Funktion, wenn x gegen die ausgeschlossenen Punkte 0 und 3 strebt und für x gegen plus-minus unendlich.

**Aufgabe 3 (5+5 Punkte)**

a) Die Darstellung des Ausdrucks Bruchstrich offene Klammer Wurzel aus 2 plus i mal Wurzel aus 2 geschlossene Klammer hoch 3 durch offene Klammer 2 mal e hoch i mal Pi durch 3 geschlossene Klammer hoch 6 in Polarform erfolgt durch Berechnung der Beträge und Argumente der komplexen Zahlen im Zähler und Nenner.

b) Um alle komplexen Lösungen der Gleichung z hoch 6 minus offene Klammer Wurzel aus 2 plus Wurzel aus 2 i geschlossene Klammer mal z hoch 2 gleich 0 zu finden, faktorisieren wir die Gleichung und verwenden die De-Moivre-Formel, um die Lösungen in Polarform zu bestimmen.

**Aufgabe 4 (6+4 Punkte)**

a) Das Taylorpolynom dritter Ordnung der Funktion g von x gleich x hoch 2 mal natürlicher Logarithmus von x im Entwicklungspunkt x gleich e wird durch Berechnung der ersten drei Ableitungen von g von x an der Stelle x gleich e und Einsetzen in die Taylorreihe ermittelt.

b) Der Fehler auf dem Intervall e bis 2e wird durch die Restgliedformel des Taylorpolynoms, zum Beispiel mit der Lagrange-Form des Restglieds, abgeschätzt.

**Aufgabe 5 (7+2 Punkte)**

a) Die Partialbruchzerlegung von h von x gleich Bruchstrich x hoch 2 plus 4 mal x minus 3 durch x hoch 3 minus 3 mal x minus 2 erfolgt durch Faktorisierung des Nenners und anschließende Zerlegung in einzelne Brüche.

b) Eine Stammfunktion von h von x wird durch Integration der Partialbrüche bestimmt.

**Aufgabe 6 (4+6 Punkte)**

a) Der Grenzwert von Wurzel aus 1 minus y hoch 2 mal natürlicher Logarithmus von offene Klammer Wurzel aus 1 minus y hoch 2 geschlossene Klammer wird durch geeignete Substitution und Grenzwertbetrachtungen berechnet.

b) Das Integral I von y gleich Integral von 0 bis y natürlicher Logarithmus von offene Klammer Wurzel aus 1 minus x hoch 2 geschlossene Klammer durch offene Klammer Wurzel aus 1 minus x hoch 2 geschlossene Klammer dx wird durch geeignete Substitution und Anwendung bekannter Integrationsmethoden gelöst.

### HM2

**Aufgabe 1 (8 Punkte)**

Um das lineare Gleichungssystem Ax gleich b zu lösen, verwendet man die Gauß-Elimination oder andere geeignete Verfahren. Der Rang der Matrix A wird durch die Anzahl der nichttrivialen Zeilen in der reduzierten Stufenform bestimmt.
...
a) Die Eigenwerte der Matrix A werden durch Lösen des charakteristischen Polynoms ermittelt. Die zugehörigen Eigenvektoren erhält man durch Einsetzen der Eigenwerte in die Gleichung offene Klammer A minus Lambda mal I geschlossene Klammer mal v gleich 0.

b) Die lineare Abbildung y gleich Ax in einer Basis, die durch die Eigenvektoren von A gebildet wird, wird durch Transformation der Matrix in Diagonalform dargestellt.

**Aufgabe 4 (4+4+3 Punkte)**

a) Die stationären Punkte der Funktion f von x, y gleich offene Klammer y hoch 2 minus x geschlossene Klammer mal natürlicher Logarithmus von x werden durch Setzen der partiellen Ableitungen gleich null gefunden.
...
a) Die Methode der Lagrange-Multiplikatoren wird verwendet, um die Kandidaten für lokale Extrema der Funktion f von x, y unter der Nebenbedingung zu bestimmen.
...
a) Zur Lösung des Anfangswertproblems x' gleich t mal x hoch 2 plus t, x von 0 gleich 0 verwendet man Methoden wie Trennung der Variablen oder die Lösung bekannter Differentialgleichungen.
...
b)
  ...
  (ii) Eine passende Funktion Phi von t, x wird durch Integration gefunden.
...
a) Die Differentialgleichung wird als parabolisch klassifiziert, da der Koeffizient von u_t positiv und die Koeffizienten von u_xx konstant sind.

b) Die Fourier-Koeffizienten werden durch Integration der ungeraden periodischen Fortsetzung von f von x gleich 1 über offenes Intervall 0, Pi geschlossenes Intervall berechnet.

c) Die Lösung der PDE mit Anfangsbedingung u von 0, x gleich Sinus von kx wird durch Trennung der Variablen und Anwendung der Randbedingungen gefunden.

**Aufgabe 4 (10 Punkte)**

a) Ein Vektorfeld besitzt ein Potential genau dann, wenn dessen Rotation verschwindet. Die Beding
