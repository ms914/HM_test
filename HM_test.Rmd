...
Natürlich, hier setze ich die Formelsammlung für die Aufgaben fort:
...
c) Bisektionsverfahren:
   - Schritt 1: Berechnung von \( p(1) \) und \( p(2) \), Bestimmung des neuen Intervalls
   - Schritt 2: Berechnung von \( p(1.5) \) und Anpassung des Intervalls entsprechend
